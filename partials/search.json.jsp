...
<json:array>
    <c:forEach var="jsonData" items="${mfs.searchData(systemUser)}">
        <json:object>
            ...
            <json:property name="link" value="${bundle.getKappLocation()}?partial=articles/${jsonData['Source'].substring(0, 1).toLowerCase()}${fn:replace(jsonData['Source'].substring(1), ' ', '')}&articleId=${jsonData['Article ID']}"/>
